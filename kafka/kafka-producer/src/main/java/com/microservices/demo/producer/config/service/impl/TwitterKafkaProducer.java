package com.microservices.demo.producer.config.service.impl;
...
public class TwitterKafkaProducer implements KafkaProducer<Long,TwitterAvroModel> {
    ...
    public void send(String topicName, Long key, TwitterAvroModel message) {
        ...
        addCallBacks(topicName, message, listenableFuture);

    }

    private void addCallBacks(String topicName, TwitterAvroModel message, ListenableFuture<SendResult<Long, TwitterAvroModel>> listenableFuture) {
        listenableFuture.addCallback(new ListenableFutureCallback<SendResult<Long, TwitterAvroModel>>() {
            ...
            public void onSuccess(SendResult<Long, TwitterAvroModel> result) {
                ...
                LOG.info("Received new metadata. topic: {}, partition:{}, offset: {}, timestamp: {}, at time {}",
                        ...
                        recordMetadata.offset(),recordMetadata.timestamp(),System.nanoTime());
