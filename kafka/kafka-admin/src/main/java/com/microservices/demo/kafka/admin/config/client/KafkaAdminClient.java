...
public class KafkaAdminClient {
    ...
    public void createTopics(){
        ...
        try {
            ...
            throw new KafkaClientException("Reached max no of attempts for creating topics",t);
        }
        checkTopicsCreated();
    ...
    public void checkTopicsCreated(){
        ...
        Long sleepTimeMs = retryConfigData.getSleepTime();
    ...
    private void sleep(Long sleepTimeMs) {
        try {
            ...
            throw new KafkaClientException("Error while waiting for new Created topics");
        }
    }
    ...
    private void checkMaxRetry(int i, Integer maxRetry) {
        ...
        if (i > maxRetry){
            throw new KafkaClientException("Reached max no of Rety for reading topics");
        }
    ...
    private Collection<TopicListing> getTopics(){
        ...
        try {
            ...
            throw new KafkaClientException("Reached max no of attempts for reading Kafka topics",t);
        }
    ...
    private Collection<TopicListing> doGetTopics(RetryContext retryContext) throws ExecutionException, InterruptedException {
        ...
        if(topics != null){
            topics.forEach( topic -> LOG.info("Topic with name {} is ready", topic.name()) );
        }
