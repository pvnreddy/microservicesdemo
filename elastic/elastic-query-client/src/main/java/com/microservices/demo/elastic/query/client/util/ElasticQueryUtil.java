...
public class ElasticQueryUtil <T extends IndexModel>{
    ...
    public Query getSearchQueryByFieldText(String filed, String text){
        return new NativeSearchQueryBuilder().withQuery(new BoolQueryBuilder().must(QueryBuilders.matchQuery(filed,text))).build();
    }
