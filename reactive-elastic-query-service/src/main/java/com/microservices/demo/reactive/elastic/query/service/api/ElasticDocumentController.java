...
public class ElasticDocumentController {
    ...
    produces = MediaType.TEXT_EVENT_STREAM_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    public Flux<ElasticQueryServiceResponceModel> getDocumentsByText(@Valid @RequestBody ElasticQueryServiceRequestModel requestModel){
        Flux<ElasticQueryServiceResponceModel> responseModelFlux =elasticQueryService.getDocumentsByText(requestModel.getText());
