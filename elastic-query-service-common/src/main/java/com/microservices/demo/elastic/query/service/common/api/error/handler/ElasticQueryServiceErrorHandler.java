...
public class ElasticQueryServiceErrorHandler {
    ...
    public ResponseEntity<String> handle(AccessDeniedException e){
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body("You are not autharized to access this Service!");
    }
    ...
    public ResponseEntity<String> handle(Exception e){
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Service runtime exception!");
    }
